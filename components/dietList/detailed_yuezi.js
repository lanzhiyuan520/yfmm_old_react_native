...
export default class DietListdetailed extends Component{
    ...
    list(){
        this.props.load(1)
       /* fetch(`http://test.na.ayi800.com/v1/article?uuid=daqcFrbaOXPKttpjzUjh4YJ6OOGeMWxR&userStatus=2&articleType=3&orderBy=weight&limit=${this.state.count}&offset=0`)
            .then((response) => {
